    ...
    <main class="overflow-hidden px-4">
        ...
        <section class="container min-h-full py-12">
            ...
            <div class="text-center mb-12" data-aos="fade-up">
                <h2 class="text-lg font-semibold text-[#8A2BE2] mb-4">ABOUT US</h2>
                <h3 class="text-4xl md:text-5xl font-bold text-[#2C3A47] leading-tight">
                    Leading the <span class="text-[#8A2BE2]">Future of Connectivity</span>
                </h3>
            </div>
            ...
            <!-- Feature Sections Grid (All items) -->
            <?php
