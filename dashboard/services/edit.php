...
$serviceData = $controller->getById((int)$id);
            ...
            <form action="process.php" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    <input type="text" name="title" required
                        value="<?php echo htmlspecialchars($serviceData['title']); ?>"
                ...
                <div>
                    ...
                    <div class="mb-3 flex items-center gap-3 p-2 border border-slate-100 rounded-xl bg-slate-50">
                        <img src="../../<?php echo htmlspecialchars($serviceData['image']); ?>"
                        ...
                        <div class="text-[10px] text-slate-500 truncate">
                            Current image: <?php echo basename($serviceData['image']); ?>
                        </div>
                    </div>
                    <?php endif; ?>
                ...
                <div>
                    ...
                    <textarea name="description" rows="6" required
                        class="w-full rounded-xl border border-slate-200 px-4 py-3 text-sm focus:outline-none focus:ring-2 focus:ring-slate-900 focus:border-transparent transition-all"><?php echo htmlspecialchars($serviceData['description']); ?></textarea>
                </div>
