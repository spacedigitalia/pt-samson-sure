                ...
                <div class="flex flex-col md:flex-row items-start md:items-center md:justify-between gap-4 md:gap-6">
                    <div class="flex items-start gap-4 flex-1">
                        ...
                        <div
                            ...
                            <i class='bx bx-envelope text-2xl md:text-3xl text-white'></i>
                        </div>

                        <!-- Title and Description -->
                        <div class="flex flex-col flex-1 min-w-0">
                            <div class="flex items-center gap-3 mb-2">
                                <h1 class="text-2xl md:text-4xl font-bold text-slate-900 tracking-tight">Contact
                                    Management</h1>
                                <span
                            ...
                            <p class="text-sm md:text-base text-slate-600 leading-relaxed max-w-2xl">
                                Kelola konten contact Buat, edit, dan hapus informasi contact
                                yang tersedia.
                            </p>

                            <!-- Stats (if contacts exist) -->
                            ...
                            <div class="flex items-center gap-4 mt-3 pt-3 border-t border-purple-100/50">
                                <div class="flex items-center gap-2 text-xs text-slate-600">
                                    ...
                                    <span class="font-medium"><?php echo count($contacts); ?> Contacts</span>
                                </div>
                                <div class="flex items-center gap-2 text-xs text-slate-600">
                                    <i class='bx bx-time text-violet-500'></i>
                                    <span>Last updated:
                                        <?php echo date('M d, Y', strtotime($contacts[0]['created_at'])); ?></span>
                                </div>
                            </div>
                            <?php endif; ?>
                        </div>
                        ...
                        <tr class="hover:bg-slate-50 transition-colors">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <a href="<?php echo htmlspecialchars($contact['link']); ?>" target="_blank"
                                    ...
                                    <span
                                        class="max-w-xs truncate"><?php echo htmlspecialchars($contact['link']); ?></span>
                                </a>
                                <?php else: ?>
                                <span class="text-sm text-slate-400 italic">No link</span>
                                <?php endif; ?>
                            </td>
                            <td class="px-6 py-4">
                                <div class="text-sm text-slate-600 max-w-md line-clamp-2">
                                    <?php echo htmlspecialchars(mb_substr($contact['description'], 0, 100)); ?>
                                    <?php if (mb_strlen($contact['description']) > 100): ?>...<?php endif; ?>
                                </div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm text-slate-600">
                                    <?php echo htmlspecialchars($contact['fullname'] ?? 'Unknown'); ?>
                                </div>
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                <div class="flex items-center justify-end gap-2">
                                    <a href="/dashboard/contact/edit.php?id=<?php echo $contact['id']; ?>"
