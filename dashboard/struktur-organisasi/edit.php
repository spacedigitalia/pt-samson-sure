...
$strukturData = $controller->getById((int)$id);
...
<div class="flex min-h-screen overflow-hidden">
    ...
    <main class="flex-1 min-w-0 h-screen overflow-y-auto px-4 md:px-8 space-y-4 pb-4">
        ...
        <div class="flex items-center justify-between">
            ...
            <a href="/dashboard/struktur-organisasi"
                ...
                <span class="hidden sm:inline">Back to Struktur Organisasi</span>
        ...
        <div class="rounded-3xl border border-slate-200 bg-white p-8 shadow-sm">
            <form action="process.php" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <input type="hidden" name="id" value="<?php echo htmlspecialchars($strukturData['id']); ?>">
                    ...
                    <?php if ($strukturData['image']): ?>
                        <div class="mb-3 p-4 border border-slate-200 rounded-xl bg-slate-50">
                            ...
                            <p class="mt-2 text-[10px] text-slate-500 truncate">
                                <?php echo basename($strukturData['image']); ?>
                            </p>
                        </div>
                    <?php endif; ?>
